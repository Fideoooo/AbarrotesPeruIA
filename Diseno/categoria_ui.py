...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame.setGeometry(QtCore.QRect(30, 30, 891, 541))
...
"border-radius: 15px;")
        ...
        self.lineEdit.setGeometry(QtCore.QRect(540, 219, 131, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
...
"padding-bottom:7px;")
        ...
        # --- aseguramos que estén al frente ---
        self.btn_back.raise_()
        self.btn_close.raise_()

        self.label_4 = QtWidgets.QLabel(self.frame)
        self.label_4.setGeometry(QtCore.QRect(530, 160, 241, 61))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(_translate("Form", "CATEOGRÍAS"))
