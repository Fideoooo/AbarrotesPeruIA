...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.frame.setGeometry(QtCore.QRect(30, 20, 471, 361))
...
"")
        ...
        self.label.setGeometry(QtCore.QRect(0, 10, 471, 331))
...
"border-radius:20px;")
        ...
        self.label_2.setGeometry(QtCore.QRect(10, 20, 451, 311))
...
"border-radius: 15px;")
        ...
        self.pushButton.setGeometry(QtCore.QRect(30, 60, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(30, 110, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_3.setGeometry(QtCore.QRect(230, 20, 241, 271))
        ...
        self.btn_close.setGeometry(QtCore.QRect(420, 30, 40, 40))  # ajusta coordenadas
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(30, 160, 161, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(30, 210, 161, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_5.setGeometry(QtCore.QRect(30, 260, 161, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
...
#PARA DARLE BRILLI BRILLI
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton.setText(_translate("Form", "Ver Stock"))
        self.pushButton_2.setText(_translate("Form", "Ver Productos"))
        self.pushButton_3.setText(_translate("Form", "Ver Categorias"))
        self.pushButton_4.setText(_translate("Form", "Ver Marcas"))
        self.pushButton_5.setText(_translate("Form", "Realizar Ventas"))
